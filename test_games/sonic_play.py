    ...
    def _update(self, dt):
        ...
        while self._sim_time < self._current_time:
            ...
            if not self._sync or act is not None:
                ...
                if done:
                    print("Finish: ", _info["prev_progress"], self._steps)
                if _info["prev_progress"]:
                    print("W1n: ", _info["prev_progress"], self._steps)
                # if done:
                #     print("done")
                #     print(_info["lives"], _info["prev_lives"])
